...
class View75_24(QDialog, Ui_ViewUICard):
    def __init__(self, parent, card: Card75_24):
        ...
        positions = [
            ...
            [(2, 0), (2, 1), (2, 3), (2, 4)],  # r 3, empty central (2,2)
            [(3, 0), (3, 1), (3, 2), (3, 3), (3, 4)],  # r 4
            [(4, 0), (4, 1), (4, 2), (4, 3), (4, 4)],  # r 5
        ]
        idx = 0
        # add_number_to_cell(self.CardWidget, 2, 2, "*")
