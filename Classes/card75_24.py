...
class Card75_24(BaseCard):
    ...
    def to_html(self) -> str:
        ...
        html += ''.join(st + str(n) + et for n in self.numbers_grid[10:12])
        html += '<td width="20%" align="center" valign="middle">&#9733;</td>\n'
        html += ''.join(st + str(n) + et for n in self.numbers_grid[12:14]) + tr
        html += ''.join(st + str(n) + et for n in self.numbers_grid[14:19]) + tr
        html += ''.join(st + str(n) + et for n in self.numbers_grid[19:24]) + tr
